...
CREATE TABLE User (
                      ...
                      global_permissions JSON NOT NULL
);
...
-- This feature (private channels) isn't functional, it seems to tedious and resource expensive to maintain. If you feel this is useful please notify @robot-penguin34
...
INSERT INTO User (id, name, handle, description, global_permissions, password, name_color) VALUE (1, 'system', 'system', 'system user', '{"admin": true}', 'nope', '#ddff00ff'); -- password is impossible to get because it is hashed normally
